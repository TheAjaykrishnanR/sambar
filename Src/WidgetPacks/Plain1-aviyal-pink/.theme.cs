...
public class Theme
{
	...
	public Brush TEXT_COLOR = Utils.BrushFromHex("#ffc3ce");
	public FontFamily FONT_FAMILY = new("Iosevka Comfy");
	...
	public Brush BUTTON_PRESSED_BACKGROUND = Utils.BrushFromHex("#562D33");
